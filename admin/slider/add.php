	...
	if (mysqli_num_rows($check_user) == 0) {
      ...
      $post_url = htmlspecialchars($_POST['url']);
			if (empty($post_judul)) {
				...
				$insert_news = mysqli_query($db, "INSERT INTO slider (id, judul, gambar, url) VALUES ('','$post_judul','$post_gambar','$post_url')");
				if ($insert_news == TRUE) {
					$msg_type = "success";
...
<html
  ...
  <head>
    ...
    <title>Tambah Slider | <?php echo $data_settings['web_name']; ?></title>
                      ...
                      <form method="POST" autocomplete="off">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input type="url" name="url" class="form-control" placeholder="https://jasaholic.com" />
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-md-12">
                              <label class="form-label">Link Gambar</label>
                              <input type="url" name="gambar" class="form-control" placeholder="https://engeeks.net/" />
                            </div>
                        </div>
