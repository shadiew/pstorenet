...
<html
  ...
  <head>
    ...
    <title>Service API | <?php echo $data_settings['web_name']; ?></title>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="demo-inline-spacing">
                        <a href="bzr" class="btn rounded-pill btn-outline-primary">Buzzerpanel</a>
                        <a href="add" class="btn rounded-pill btn-outline-danger">API Key</a>
                        <a href="id" class="btn rounded-pill btn-outline-secondary">API ID</a>
              </div>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            ...
                            <td><?php echo $data_show['pin']; ?><?php echo $data_show['api_id']; ?><?php echo $data_show['secret_key']; ?></td>
                            
                            <td>
                              <div class="demo-inline-spacing" style="<?php if ($data_show['code'] == "MANUAL") {
                                    echo "display:none;";
                                  } ?>">
                                <a href="delete.php?id=<?php echo $data_show['id']; ?>" class="btn rounded-pill btn-label-danger">Hapus</a>
                              </div>
                            </td>
                        </tr>
                        <?php
