	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['delete'])) {
			...
			if (mysqli_num_rows($checkdb_news) == 0) {
				...
				$delete_news = mysqli_query($db, "DELETE FROM slider WHERE id = '$post_id'");
				if ($delete_news == TRUE) {
					$msg_type = "success";
...
<html
  ...
  <head>
    ...
    <title>Slider Mobile | <?php echo $data_settings['web_name']; ?></title>
              ...
              <div class="card">
                <div class="card-datatable table-responsive pt-0">
                  <table id="datasosmed" class="table table-striped" style="width:100%">
                    ...
                    <?php
							// start paging config
							$query_list = mysqli_query($db, "SELECT * FROM slider ORDER BY id DESC"); // edit
							$no = 1;
							// end paging config
