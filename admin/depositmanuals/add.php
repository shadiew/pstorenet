...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['add'])) {
            ...
            $post_kode = htmlspecialchars($_POST['code']);
			...
			if (empty($post_name) || empty($post_data) || empty($post_note)) {
				$msg_type = "error";
				...
				$insert_service = mysqli_query($db, "INSERT INTO deposit_method (code, name, name_method, data, note, rate) VALUES ('$post_kode', '$post_name', 'MANUAL', '$post_data', '$post_note', '0')");
				if ($insert_service == TRUE) {
					$msg_type = "success";
					$msg_content = "Deposit Method Added.";
				} else {
					$msg_type = "error";
...
<html
  ...
  <head>
    ...
    <title>Tambah Pembayaran Manual | <?php echo $data_settings['web_name']; ?></title>
                      ...
                      <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input type="text" name="name" class="form-control" placeholder="BANK Central Asia" autofocus/>
                            </div>
                            <div class="col-md-12">
                              <label class="form-label">Kode</label>
                              <input type="text" name="code" class="form-control" placeholder="BNI" />
                            </div>
                            <div class="col-md-12">
                              <label class="form-label">No./Rekening</label>
                              <input type="text" name="data" class="form-control" placeholder="082221584446" />
                            </div>
                            <div class="col-md-12">
                              <label class="form-label">Pemilik Rekening</label>
                              <input type="text" name="note" class="form-control" placeholder="Sadiwantoro" />
                            </div>
