...
<html
  ...
  <head>
    ...
    <title>Halaman User | <?php echo $data_settings['web_name']; ?></title>
              ...
              ?>
                        <tr>
                            ...
                            <td><div class="demo-inline-spacing">
                                <a href="delete.php?username=<?php echo $data_show['username']; ?>" class="btn rounded-pill btn-label-danger btn-xs">Hapus</a>
                                <a href="edit.php?username=<?php echo $data_show['username']; ?>" class="btn rounded-pill btn-label-primary btn-xs">Edit</a>
                              </div></td>
                        </tr>
                        <?php
              }
