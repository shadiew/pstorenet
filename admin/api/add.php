              ...
              <div class="row">
                      ...
                      <form method="POST">
                          ...
                          <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input type="text" name="link" class="form-control" placeholder="https://namadoamin.com" />
                            </div>
                          </div>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <p>
                      Silahkan anda tambahkan data sesuai dengan form yang disediakan. API ini support:
                      <li>SMM PRO</li>
                      <li>Justanotherpanel</li>
                      <li>Cheappanel</li><li>Dll</li>
                      </p>
                    </div>
                  </div>
                </div>
