...
<html
  ...
  <head>
    ...
    <title>Hapus Pembayaran Manual | <?php echo $data_settings['web_name']; ?></title>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="<?php echo $cfg_baseurl; ?>/admin/depositmanuals/">
                        <div class="row g-3">
                            <div class="col-md-12">
                              <label class="form-label">Nama BANK</label>
                              <input type="text" name="id" class="form-control" value="<?php echo $datadb_service['id']; ?>" readonly/>
                            </div>
                        </div>
                        <div class="pt-4">
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <p>
                       Data yang dihapus tidak dapat di kembalikan lagi, pastikan kembali data yang akan anda hapus
                      </p>
                    </div>
                  </div>
                </div>
