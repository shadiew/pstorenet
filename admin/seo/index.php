...
<html
  ...
  <head>
    ...
    <title>Pengaturan SEO | <?php echo $data_settings['web_name']; ?></title>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Pengaturan SEO Website</h5>
                      ...
                      <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input type="text" name="web_title" value="<?php echo $datadb_service['web_title']; ?>" class="form-control" placeholder="John" />
                            </div>
                          ...
                          <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Deskripsi Website</label>
                          <textarea class="form-control" 
                            name="web_description"
                            class="form-control"
                            placeholder="Deskripsikan Website kamu" rows="4" 
                            ><?php echo $datadb_service['web_description']; ?></textarea>
                          </div>


                          <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Keyword Website</label>
                          <textarea class="form-control" 
                            name="seo_keywords"
                            class="form-control" rows="4" 
                            placeholder="Keyword Website, Contoh domain,website,dll" 
                            ><?php echo $datadb_service['seo_keywords']; ?></textarea>
                          </div>


                          <div class="mb-3">
                          <label class="form-label" for="basic-default-message">SEO Meta</label>
                          <textarea class="form-control" 
                            name="seo_meta"
                            class="form-control" rows="4" 
                            placeholder="Keyword Website, Contoh domain,website,dll" 
                            ><?php echo $datadb_service['seo_meta']; ?></textarea>
                            <small>Support code dan javascript</small>
                          </div>


                          <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Googel Analitik</label>
                          <textarea class="form-control" 
                            name="seo_analytics"
                            class="form-control" rows="4" 
                            placeholder="Keyword Website, Contoh domain,website,dll" 
                            ><?php echo $datadb_service['seo_analytics']; ?></textarea>
                            <small>Support Javascript Code</small>
                          </div>

                          <div class="mb-3">
                          <label class="form-label" for="basic-default-message">Live Chat</label>
                          <textarea class="form-control" 
                            name="seo_chat"
                            class="form-control" rows="4" 
                            placeholder="Keyword Website, Contoh domain,website,dll" 
                            ><?php echo $datadb_service['seo_chat']; ?></textarea>
                            <small>Support Javascript Code</small>
                          </div>
