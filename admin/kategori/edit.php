...
<html
  ...
  <head>
    ...
    <title>Edit Kategori Sosmed | <?php echo $data_settings['web_name']; ?></title>
                      ...
                      <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input type="text" name="code" class="form-control" value="<?php echo $datadb_user['code']; ?>" placeholder="Instagram Follower" />
                            </div>
