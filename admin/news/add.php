...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['add'])) {
            ...
            $post_gambar = htmlspecialchars($_POST['gambar']);
			if (empty($post_content) || empty($post_status)) {
				$msg_type = "error";
				$msg_content = "Please Fill In All Inputs.";
			} else {
				$insert_news = mysqli_query($db, "INSERT INTO news (date, time, content, status, gambar) VALUES ('$date','$time','$post_content','$post_status','$post_gambar')");
				if ($insert_news == TRUE) {
					$msg_type = "success";
...
<html
  ...
  <head>
    ...
    <title>Tambah News | <?php echo $data_settings['web_name']; ?></title>
                      ...
                      <form method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <textarea type="text" name="content" class="form-control" placeholder="Instagram Follower Sedang perbaikan" /></textarea>
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-md-12">
                              <label class="form-label">Link Gambar</label>
                              <input type="link" name="gambar" class="form-control" placeholder="https://engeeks.net/" />
                            </div>
                        </div>
                        ...
                        <div class="pt-4">
                          ...
                          <a href="../news" class="btn btn-warning">Kembali</a>
                        </div>
                      </form>
                    </div>
                  </div>
