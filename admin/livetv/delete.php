	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_GET['id'])) {
			...
			if (mysqli_num_rows($checkdb_news) == 0) {
				header("Location: ".$cfg_baseurl."admin/livetv/");
			} else {
				$page = "livetv";
...
<html
  ...
  <head>
    ...
    <title>Hapus Livetv | <?php echo $data_settings['web_name']; ?></title>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Hapus LiveTv</h5>
                      
                    </div>
                    <div class="card-body">
                      <form method="POST" action="<?php echo $cfg_baseurl; ?>/admin/livetv/">
                      ...
                      <input type="hidden" name="id" value="<?php echo $datadb_news['id']; ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input class="form-control" placeholder="Content" readonly value="<?php echo $datadb_news['judul']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="pt-4">
                          ...
                          <a href="../livetv" class="btn btn-warning">Kembali</a>
                        </div>
                      </form>
                    </div>
                  </div>
