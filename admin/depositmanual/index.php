				...
				while ($data_show = mysqli_fetch_assoc($query_list)) {
					...
					?>
                        <tr>
                            ...
                            <td><?php echo rupiah($data_show['amount'],3); ?></td>
                            <td>
                            ...
                            <td><?php
                                if ($data_show['status'] == "YES" || $data_show['status'] == "CANCEL" || $data_show['status'] == "Success") {
                                    ?>
                            <a class="btn btn-xs btn-warning"><?php echo $status; ?></a>
                            <?php
                          } else { ?>
                            <a href="edit.php?id=<?php echo $data_show['id']; ?>" class="badge rounded-pill bg-<?php echo $label; ?>">Konfirmasi</a>
                            <?php
                          }
                          ?>
                            </td>
