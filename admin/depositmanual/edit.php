...
<html
  ...
  <head>
    ...
    <title>Konfirmasi Deposit Manual | <?php echo $data_settings['web_name']; ?></title>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Konfirmasi Deposit</h5>
                    ...
                    <div class="card-body">
                      <form method="POST">
                          ...
                          <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <select class="form-control" name="status">
										...
										<option value="YES">Konfirmasi</option>
                        ...
                        <div class="pt-4">
                          <button type="submit" name="edit" class="btn btn-primary">Konfirmasi</button>
                          <a href="../depositmanual" class="btn btn-warning">Kembali</a>
                        </div>
                      </form>
                    </div>
                  </div>
...
<?php
			...
			header("Location: ".$cfg_baseurl."/admin/depositmanual/");
		}
	}
} else {
	header("Location: ".$cfg_baseurl);
