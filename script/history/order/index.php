								...
								// end paging config
												...
												?>
													<tr>
														...
														<td align="center"><label class="badge badge-<?php if($data_order['refund'] == 0) { echo "danger"; } else { echo "success"; } ?>"><?php if($data_order['refund'] == 0) { ?><i class="icon icon-times"></i><?php } else { ?><i class="icon icon-check"></i><?php } ?></label></td>
													</tr>
												<?php
												}
												?>
