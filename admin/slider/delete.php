...
if (isset($_SESSION['user'])) {
  ...
  if (mysqli_num_rows($check_user) == 0) {
    ...
    if (isset($_GET['id'])) {
      $post_id = $_GET['id'];
      $checkdb_news = mysqli_query($db, "SELECT * FROM slider WHERE id = '$post_id'");
      $datadb_news = mysqli_fetch_assoc($checkdb_news);
      if (mysqli_num_rows($checkdb_news) == 0) {
        header("Location: ".$cfg_baseurl."admin/slider/");
      } else {
        $page = "slider";
...
<html
  ...
  <head>
    ...
    <title>Hapus Slider | <?php echo $data_settings['web_name']; ?></title>
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Hapus Slider</h5>
                      
                    </div>
                    <div class="card-body">
                      <form method="POST" action="<?php echo $cfg_baseurl; ?>/admin/slider/">
                      ...
                      <input type="hidden" name="id" value="<?php echo $datadb_news['id']; ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <input class="form-control" placeholder="Content" readonly value="<?php echo $datadb_news['id']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="pt-4">
                          ...
                          <a href="../slider" class="btn btn-warning">Kembali</a>
                        </div>
                      </form>
                    </div>
                  </div>
