            ...
            <div class="tab-pane animated fadeInUpShort show active" id="dashboard">
                        ...
                        <div class="counter-box white r-5 p-3">
                            <div class="p-4">
                                ...
                                if ($data_user['balance'] == "0" or $data_user['balance'] < 0) {
                                    ?>
                                <h5>$<?php echo number_format($data_user['balance']); ?></h5>
                                <?php
                                } ?>
                                <?php
                                if ($data_user['balance'] > 0) {
                                    ?>
                                <h5>$<?php echo number_format($data_user['balance'], 4); ?></h5>
                                <?php
                                } ?>	
                            </div>
                            <div class="progress progress-xs r-0">
                ...
                <div class="col-md-12">
                        <div class="white p-5 r-5">
                            ...
                            <div class="row my-3">
                                <div class="col-md-3">
                                    <div class="my-3 mt-4">
                                        <h5>Spent <span class="green-text">+ $<?php echo number_format($data_order_today['total'], 2); ?></span></h5>
                                        <span class="s-24">$<?php echo number_format(number_format($data_order['total'], 4) - number_format($data_order_today['total'], 4), 4); ?></span>
                                        <p class="tsg-dash-spent-box">You had spent <b>$<?php echo number_format($data_order['total'], 4); ?></b> in total.<br/>Thanks for trusting <?php echo $data_settings['web_name']; ?>.</p>
                                    </div>
                ...
                <div class="card no-b shadow  mt-3 mb-3">
                    ...
                    <table class="table cell-vertical-align-middle mb-0">
                                <tr class="no-b">
                                <td><h4 class="mb-0">This is user dashboard. You can visit the admin dashboard by using this button.</h4></td>
                                <td>
